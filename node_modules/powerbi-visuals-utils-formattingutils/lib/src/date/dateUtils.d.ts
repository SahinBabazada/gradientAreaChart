 ...
 */
export declare function addYears(date: Date, yearDelta: number): Date;
/**
 * Adds a specified number of months to the provided date.
 * @param date - date value
 * @param monthDelta - number of months to add
 */
export declare function addMonths(date: Date, monthDelta: number): Date;
/**
 ...
 */
export declare function addMilliseconds(date: Date, milliseconds: number): Date;
